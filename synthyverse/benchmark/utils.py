...
def format_results(data: dict, value_at_level: int = 3) -> pd.DataFrame:
    """Format nested dictionary data into a dataframe.
    ...
    def extract_metrics_recursive(d, current_level=0, context_dict=None):
        ...
        Args:
            ...
            context_dict: Dictionary storing context information.

        Returns:
            list: List of dictionaries, each representing a metric row.
        """
